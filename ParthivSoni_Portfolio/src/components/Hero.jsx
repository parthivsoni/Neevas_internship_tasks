            ...
            <div className="flex flex-wrap">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        initial="hidden"
                        animate="visible"
                        className="pb-16 text-6xl font-medium tracking-tight lg:mt-16 lg:text-8xl">Parthiv Soni</motion.h1>
                        ...
                        initial="hidden"
                        animate="visible" className="my-2 max-w-xl py-6 tracking-tighter text-2xl">{HERO_CONTENT}</motion.p>
                    </div>
                </div>
